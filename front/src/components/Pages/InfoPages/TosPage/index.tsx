...
export const TosPage = () => (
  <S.Container>
    ...
    <p>
      <b>
        By accessing the website, you agree that you have read, 
        understood, and agreed to be bound by all of these legal terms.
      </b>
    </p>

    <p>
      If you do not agree with any of these legal terms,
      you are prohibited from using the service, and you must cease use immediately.
    </p>
    ...
    <ul>
      ...
      <li>
        Not programatically retrieve data or other content from
